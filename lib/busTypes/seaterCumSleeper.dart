...
class SeaterCumSleeper extends StatefulWidget {
  final String busId;
  final String uEmail;
  const SeaterCumSleeper({Key? key, required this.busId, required this.uEmail}) : super(key: key);

  @override
  State<SeaterCumSleeper> createState() => _SeaterCumSleeperState();
}

class _SeaterCumSleeperState extends State<SeaterCumSleeper> {
  ...
  IconButton buildSeatIconButton(int rowIndex, int seatIndex) {
    ...
    return IconButton(
      ...
      splashRadius: 30.0,
      tooltip: 'Seat Number : ${(rowIndex * 3 + seatIndex).toString()}',
    );
  }
