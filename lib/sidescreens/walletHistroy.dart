...
class WalletHistroy extends StatefulWidget {
  final String uEmail;
  const WalletHistroy({Key? key, required this.uEmail}) : super(key: key);

  @override
  State<WalletHistroy> createState() => _WalletHistroyState();
}

class _WalletHistroyState extends State<WalletHistroy> {
  ...
  getWalletDetails() async{
    QuerySnapshot querySnapshot = await busService.ReadWalletHistroy(widget.uEmail!);
    ...
    for(int i = 0;i < length;i++){
      setState(() {
        ...
        if(walletList[i].split(',')[7].split(':')[1].replaceAll('}', '') == 'true'){
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Wallet Histroy",style: TextStyle(
            fontSize: 18.0,
                    ...
                    Row(
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            const Text("TOTAL WALLET BALANCE HISTROY",style: TextStyle(
                                fontSize: 13.0,
                                color: Colors.grey,
                                fontWeight: FontWeight.w600,
                                fontFamily: 'Raleway'
            ...
            child: Visibility(
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (context, index){
                    return Card(
                        child: ListTile(
                          leading: walletList[index].split(',')[7].split(':')[1].replaceAll('}', '').trim() == 'true' ? const CircleAvatar(
                            radius: 30.0,
                          ...
                          title: Column(
                            children: [
                              Row(
                                ...
                                children: [
                                  Text(walletList[index].split(',')[3].split(':')[1].replaceAll('{', ''),style: const TextStyle(
                                    fontFamily: 'Raleway',
                                    color: Colors.grey,
                                  ),),
                                  const SizedBox(
                                  ...
                                  walletList[index].split(',')[7].split(':')[1].replaceAll('}', '').trim() == 'true' ? Text('- ${walletList[index].split(',')[2].split(':')[1]}',style: const TextStyle(
                                    fontFamily: 'Raleway',
                                    fontSize: 13.0,
                                    color: Colors.red,
                                    fontWeight: FontWeight.bold,
                              ...
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text(walletList[index].split(',')[4].split(':')[1],style: const TextStyle(
                                    fontFamily: 'Raleway',
                                    color: Colors.black,
                                  ),),
                                  const SizedBox(
                                  ...
                                  const Text('(Reused Ticket)',style: TextStyle(
                                    fontSize: 10.0,
                                    fontFamily: 'Raleway',
                                    color: Colors.grey,
                                  ),
                              ...
                              const Text('Balance Added from',style: TextStyle(
                                fontFamily: 'Raleway',
                                fontSize: 14.0,
                                fontWeight: FontWeight.bold,
                                color: Colors.black,
                              ...
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text(walletList[index].split(',')[0].split(':')[1],style: const TextStyle(
                                    fontFamily: 'Raleway',
                                    fontSize: 13.0,
                                    color: Colors.black,
                                  ),),
