...
class UserDetails extends StatefulWidget {
  ...
  final String uEmail;
  const UserDetails({Key? key, required this.docId, required this.seats, required this.uEmail}) : super(key: key);
...
class _UserDetailsState extends State<UserDetails> {
  ...
  getBusDetails() async{
    ...
    for(int i = 0;i < widget.seats.length;i++){
      int n = int.parse(widget.seats.elementAt(i));
      if(n == 1 || n == 4 || n == 5 || n == 8 || n == 9 || n == 12 || n == 13 || n == 16 || n == 17
        || n == 20 || n == 21 || n == 24 || n == 25 || n == 28 || n == 29 || n == 32
        || n == 33 || n == 36 || n == 37 || n == 41 || n == 44 || n == 45 || n == 48 || n == 49 || n == 53){
        seatsList.add('$n W');
      }
      else{
        seatsList.add('$n');
