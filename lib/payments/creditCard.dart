...
class CreditCard extends StatefulWidget {
  ...
  final String uEmail;
  CreditCard({Key? key, required this.bookingList, required this.uEmail}) : super(key: key);
...
class _CreditCardState extends State<CreditCard> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text("Payments -> Credit Card",style:
          TextStyle(
              fontSize: 15.0,
          ...
          child: Card(
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    const Text("Visa Gold Credit Card",style: TextStyle(
                      fontSize: 15.0,
                      fontWeight: FontWeight.w600,
                      fontFamily: 'Raleway',
  ...
  setBookings(String name, String num, String cvv, String exp) async{
    ...
    mapping['paymentMode'] = 'Credit Card';
